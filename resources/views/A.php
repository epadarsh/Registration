                ...
                <div class="panel-body">
                    <form role="form" name="update-form" id="update_form" action="{{route('store-data')}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 {{ $errors->get('mobile') ? 'has-error' : '' }}">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //     location.reload();
        // });
        // BODY.submit("#search_form", function (e) {
        // $("#search_form").submit(function (e) {
        //     e.preventDefault();
        //     let actionUrl = "search-function";
